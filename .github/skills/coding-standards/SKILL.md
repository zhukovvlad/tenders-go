...
- Логирование одной и той же ошибки в нескольких слоях: ошибки логируем только на boundary-слое (HTTP-хендлеры, воркеры и т.п.), сервисный слой — только оборачивает и пробрасывает.
